                ...
                <div class="w-full">
                    ...
                    <form role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <label class="block mt-2 text-sm">
                            ...
                            <input name="name" type="text" value="{{ old('name') }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                            @error('name')
                        ...
                        <label class="block mt-2 text-sm">
                            <span class="text-gray-700 dark:text-gray-400">{{ __('Surname') }}</span>
                            <input name="surname" type="text" value="{{ old('surname') }}" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                            @error('surname')
                                <span class="text-xs text-red-600 dark:text-red-400">
                                    {{ $message }}
                                </span>
                        ...
                        <label class="block mt-2 text-sm">
                            ...
                            <input name="password" type="password" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                            @error('password')
                                <span class="text-xs text-red-600 dark:text-red-400">
                                    {{ $message }}
                                </span>
